...
class GANModel(nn.Module):
    ...
    def train(self, train_loader, num_epochs=150, learning_rate=0.00002):
        ...
        for epoch in range(num_epochs):
            ...
            if epoch > 110:
                # print(0)
                torch.save(self.generator.state_dict(), os.path.join(save_dir, f'generator8_epoch_{epoch}.pt'))
                torch.save(self.discriminator.state_dict(), os.path.join(save_dir, f'discriminator8_epoch_{epoch}.pt'))
...
# wandb.watch(gan)
# gan.train(train_loader=dataloader, num_epochs=150, learning_rate=0.00002)  # 训练模型
#
# wandb.finish()
